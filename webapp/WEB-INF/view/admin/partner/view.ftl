...
<!-- ********************************  담당자  ******************************** -->
<!-- ********************************************************************* -->
<@listTable name="manager-table" size=5 headers=["1 $index No", "1 position 직책", "2 name 이름",  "2 tel 전화번호", "2 fax 팩스", "2 email 이메일", "1 $delete 삭제"] addList="/WEB-INF/view/admin/includes/scrollTable-add-manager.ftl" />
...
<!-- ********************************  주소  ******************************** -->
<!-- ********************************************************************* -->
<@listTable name="address-table" size=5 headers=["1 $index No", "5 text 주소", "3 mobile 연락처", "2 name 받는사람", "1 $delete 삭제"] addList="/WEB-INF/view/admin/includes/scrollTable-add-address.ftl" />
...
<!-- ********************************  계좌  ******************************** -->
<!-- ********************************************************************* -->
<@listTable name="bank-table" size=3 headers=["1 $index No", "2 bankName 은행", "5 accountNum 계좌번호", "3 holder 예금주", "1 $delete 삭제"] addList="/WEB-INF/view/admin/includes/scrollTable-add-bank.ftl" />
