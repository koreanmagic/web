				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							...
							<div class="tooltip-focus input-group item-category">
								<input id="item" name="item" type="text" class="tooltip-target" data-ui-dropdown="._item-names" autocomplete="off" readonly>
