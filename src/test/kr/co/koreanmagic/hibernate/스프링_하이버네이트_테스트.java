...
import kr.co.koreanmagic.hibernate.mapper.config.SpringConfiguration;
import kr.co.koreanmagic.hibernate.mapper.test.TestTable;
...
public class 스프링_하이버네이트_테스트 extends TestDao {
